    ...
    <div className='m-0 p-0 ' >
      <div className="container-fluid bg-dark text-white d-flex "
        ...
        <div className="container-fluid bg-dark text-white d-flex  justify-content-center align-items-center flex-column">
          ...
          <h5 className='' style={{ margin:"10px", textTransform: "capitalize" }} >Welcome to the Daily Latest Top News Feed Space</h5>
          <h5 className='heroDesc' style={{  textTransform: "uppercase", paddingTop: "20px" }} id='scroll-text' >Get the todays top News on your feed. Choose Country and then choose the category.</h5>
