      ...
      <div classNameName='p-4 py-5'>
        <div className='container my-2 d-flex justify-content-top align-items-center flex-column my-3' style={{ minHeight: "100vh" }}>
          <div className='p-4' style={{width: "600px", textAlign:"justify"}}>
            <h3 style={{ textAlign: "left", marginBottom: "20px" }}><span className='pageText'>Terms and Conditions</span></h3>
            <h4 >Welcome to News Feed!</h4>
            <p>These terms and conditions lay forth the groundwork for using News Feed website, which may be found at https://newsfeed.com
            </p>
            <p>We assume that by accessing this website, you agree to these terms and conditions. If you do not agree to all of the terms and conditions listed on this page, do not use News Feed.
            </p>
            ...
            <h4>Cookies</h4>
            <p>Cookies are used on this site. You accepted to use cookies in accordance with the News Feed Privacy Policy by visiting News Feed
            </p>
            <p>Cookies are used by most interactive websites to allow us to retrieve the user's information for each visit. Cookies are used on our website to allow specific areas to work and to make things easier for users. Certain of our affiliate/advertising partners may also utilize cookies.
            </p>
            <h4>License</h4>
            <p>Unless otherwise stated, all intellectual property rights in all material on News Feed are owned by News Feed and/or its licensors. All rights to intellectual property are reserved. You may use this for your own personal use from News Feed, subject to the restrictions set forth in these terms and conditions.
            </p>
            <h5>You must not:</h5>

            <p> Republish material from News Feed </p>
            <p> Sell, rent, or sub-license material from News Feed </p>
            <p> Reproduce, duplicate or copy material from News Feed </p>
            <p> Redistribute content from News Feed </p>
            <p> This agreement's term begins on the date hereof. The Terms And Conditions Generator and the Privacy Policy Generator were used to  construct our Terms and Conditions.</p>
            <p> Parts of this website allow users to post and exchange thoughts and information in designated places. Prior to their appearance on the Internet, News Feed does not filter, edit, publish, or review Comments. The thoughts and opinions expressed in the comments do not reflect those of News Feed, its agents, or affiliates. The views and opinions expressed in comments reflect the views and opinions of the individual who posted them. News Feed shall not be liable for the Comments or for any liabilities, damages, or expenses caused and/or suffered as a result of the use of and/or posting of and/or appearance of the Comments on this website, to the extent permitted by applicable laws.</p>
            <p> News Feed has the right to review all Comments and to remove any Comments that are inappropriate, offensive, or violate our Terms and Conditions.</p>

            <h5>You warrant and represent that:</h5>
            <p>You have the essential rights and consent to post the Comments on our website, and you have been given permission to do so.</p>
            <p>No third-party intellectual property rights, such as copyright, patents, or trademarks, are infringed upon by the Comments.</p>
            <p>In the Comments, there is no defamatory, libelous, offensive, indecent, or otherwise unlawful content that constitutes a privacy invasion.</p>
            <p>The Comments will not be used to solicit or promote any type of business, custom, or current commercial or illegal activity.</p>
            <p>You hereby grant News Feed a non-exclusive license to use, reproduce, edit, and authorize others to use, reproduce, edit, and authorize others to use, reproduce, edit, and authorize others to use, reproduce, and edit any of your Comments in any form, format, or media.</p>

            <h4>Hyperlinking to our Content</h4>
            <h5>Without prior written permission, the following organizations may link to our website:
            </h5>
            <h6>Government agencies;</h6>
            <h6>Search engines;</h6>
            <h6>News organizations;</h6>
            <p>Distributors of online directories may link to our website in the same way that they connect to the websites of other businesses included in the directory.; and</p>
            <p>Except for soliciting non-profit organizations, charity shopping malls, and charity fundraising clubs, which are not permitted to link to our website.</p>
            ...
            <h5>Other link requests from the following categories of organizations may be considered and approved:</h5>
            ...
            <p>accounting, law, and consulting firms; andeducational institutions and trade associations.</p>
            <p>We will approve link requests from these organizations if we determine that: (a) the link will not reflect poorly on us or our accredited businesses; (b) the organization has no negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates for the absence of News Feed and (d) the link will be in the context of general resource information.</p>
            ...
            <p>Please contact us by email at News Feed if you are one of the organizations listed in paragraph 2 above and would want to link to our website. Include your name, the name of your organization, contact information, and the URL of your website, as well as a list of any URLs from which you intend to link to our site and a list of the URLs on our site to which you would like to connect. Expect a response in two to three weeks.</p>
            <p>Approved organizations may use the following URL to link to our website:</p>
            <p>By use of our corporate name; or</p>
            <p>The usage of a unified resource locator (URL) that is linked to; or</p>
            <p>By describing our Website in any other way that makes sense in the context and format of the linked party's website's content.</p>
            <p>There will be no use of News Feed logo or any artwork for linking without a trademark license agreement.</p>

            <h4>iFrames</h4>
            <p>Without prior approval and written agreement, you may not put frames around our Webpages that alter the visual presentation or look of our Website.
            </p>
            ...
            <h5>Disclaimer</h5>
            <p>To the largest extent permitted by applicable law, we disclaim any and all claims, warranties, and conditions relating to this website and its use. Nothing in this disclaimer should be construed as:
