...
export const Disclaimer = () => {
  return (
    <div className='my-5' style={{ minHeight: "100vh" }}>
      <div className='p-4'>
        <h4>Disclaimer for News Feed</h4>
        <p>
          Please contact us by email at indinatechnoera@gmail.com if you require any additional information or have any queries about our site's disclaimer.
        </p>
        <h4>Disclaimers for News Feed</h4>
        <p>
          All information on this website - https://newsfeed.com - is provided in good faith and solely for the purpose of providing general information. News Feed takes no responsibility or warranties about the completeness, accuracy, or reliability of this information. Any action you take as a result of the information on this website (News Feed) is solely at your own risk. News Feed is not responsible for any losses or damages incurred as a result of using our website.
        </p>
        <p>
        ...
        <p>
          Please be aware that when you leave our website, other sites' privacy policies and conditions may differ from ours, and we have no control over them. Before doing any business or posting any information, please read the Privacy Policies as well as the "Terms of Service" of these sites. The blogEarns's Privacy Policy Generator created our Privacy Policy.
        </p>
        <h4>
          Consent
        </h4>
