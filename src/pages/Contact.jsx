...
export const Contact = () => {
  ...
  // define name value of tag in output
      ...
      <div classNameName='p-4 py-5'>
        <div className='container my-2 d-flex justify-content-top align-items-center flex-column my-3' style={{ minHeight: "100vh" }}>
          <div className='p-4' style={{ width: "600px", textAlign: "justify" }}>
            <h3 style={{ textAlign: "left", marginBottom: "20px" }}><span className='pageText'>Contact Us</span></h3>
            <form ref={form} onSubmit={sendEmail} style={{ width: "400px", marginTop: "10px" }} >
              <label for="user_name">User Name</label>
              <input type="text" id="user_name" name="user_name" placeholder="Enter Full Name" />
              ...
              <input type="text" id="phone" name="phone" placeholder='Phone Number' pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"></input>
              <label for="message">Message</label>
              <textarea id="message" name="message" placeholder="Write your message" style={{ height: "200px" }}></textarea>
              <input type="hidden" id="submited_From" name="submited_From" value="News Feed" />
              <input className='contactSubmitBtnInput' type="submit" value="Send" style={{ backgroundColor: "black" }} />
            </form>
          </div>
        </div>
      </div>
